...
const divy = new Student("Fnu", "Divyam", "123 no way I will share it", ["Eng1A", "CIT93"])
divy.showStatus()
const jane = new Person("Jane", "Doe", "23 my house")
jane.showStatus()
console.log(divy.getFirstName())
console.log(jane.getAddress())
console.log(divy.setLastName('Wallor'))
console.log(divy.getLastName())
